...
function draw() {
  ...
  push();
  translate(width * 1,height * -1.5, width * 1.75);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        ...
        rect(x*scl02 * 2, y*scl02, scl02, scl02);
        }
    }
  pop();
  
  push();
  translate(width * 1,height * -1.5, width * -4.5);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        for (let x = 0; x < cols02; x++) {
  ...
  pop();
   ...
   push();
  translate(width * 1,height * -1.5, width * -8.75);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        for (let x = 0; x < cols02; x++) {
